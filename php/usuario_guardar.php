  ...
  if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    if ($check_email->rowCount() > 0) {
      ...
      <div class="notification is-danger">
              ...
              <strong>¡Ocurrio un error inesperado!</strong>, 
             El EMAIL ingresado ya se encuentra registrado, por
             favor elija otro.
            </div>
...
El usuario se registro con exito.</div>
';
} else {
  echo '
  <div class="notification is-danger is-light">
  <strong>¡Ocurrio un error inesérado!</strong><br>
No se pudo registrar el usuario, por favor intente nuevamente.</div>
